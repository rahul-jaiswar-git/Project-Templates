## How to use the shields badges?

1. Get the URL
2. Create the img tag `<img src="BadgeURLHere" />` or `![image](BadgeURLHere)`
3. Copy and paste into your readme

## Menu

- [How to use the shields badges?](#how-to-use-the-shields-badges)
- [Menu](#menu)
- [Contact](#contact)
- [Social](#social)
- [Blog](#blog)
